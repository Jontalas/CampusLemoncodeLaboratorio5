...
var mostrarArticulo = (articulo) => {
    document.write("<li>Articulo: " + articulo.name + "</li>");
    document.write("<li>- id: " + articulo.id + "</li>");
    document.write("<li>- precio: " + Number(articulo.price).toFixed(2) + "€</li>");
    document.write("<li>- cantidad: " + articulo.count + "</li>");
    document.write("<li>- premium: " + (articulo.premium ? "si" : "no") + "</li>");
};
